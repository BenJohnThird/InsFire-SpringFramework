    ...
    <a class="btn btn-primary btn-lg" href="#" role="button">Learn more</a>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('${images}/forest2.jpg')">
          ...
          <div class="carousel-item" style="background-image: url('${images}/forest1.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>Second Slide</h3>
          ...
          <div class="carousel-item" style="background-image: url('${images}/forest3.jpg')">
            <div class="carousel-caption d-none d-md-block">
              <h3>Third Slide</h3>
